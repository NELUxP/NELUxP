...
const buttonVariants = cva(
  "block items-center justify-center whitespace-nowrap font-minecraft text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 overflow-hidden", // Added overflow-hidden
  {
    variants: {
      variant: {
